...
#
# lab3_proj.tcl: Tcl script for re-creating project 'lab3_proj'
#
# Generated by Vivado on Fri Sep 30 12:04:07 PDT 2022
...
#
# 1. This project restoration tcl script (lab3_proj.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/users3/ss421111/soc_lab/lab3/hardware/lab3_proj/lab3_proj.srcs/utils_1/imports/synth_1/system_wrapper.dcp"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/home/users3/ss421111/soc_lab/lab3/hardware/constr/zybo_constr.xdc"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/lab3_proj/lab3_proj.srcs/utils_1/imports/synth_1/system_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/constr/zybo_constr.xdc"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set orig_proj_dir "[file normalize "$origin_dir/lab3_proj"]"
...
set file "[file normalize "$origin_dir/constr/zybo_constr.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/constr/zybo_constr.xdc"
...
set obj [get_filesets constrs_2]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/constr/zybo_constr.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/constr/zybo_constr.xdc"]" -objects $obj
...
gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#qspi_fbclk#gpio[9]#gpio[10]#gpio[11]#gpio[12]#gpio[13]#gpio[14]#gpio[15]#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#data[4]#dir#stp#nxt#data[0]#data[1]#data[2]#data[3]#clk#data[5]#data[6]#data[7]#clk#cmd#data[0]#data[1]#data[2]#data[3]#reset#cd#tx#rx#gpio[50]#gpio[51]#mdc#mdio} \
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_TopLeft":"-25,-31",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 4 -x 1020 -y 370 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 4 -x 1020 -y 390 -defaultsOSRD
preplace port btns_4bits -pg 1 -lvl 4 -x 1020 -y 220 -defaultsOSRD
preplace port sws_4bits -pg 1 -lvl 4 -x 1020 -y 80 -defaultsOSRD
...
preplace inst axi_gpio_1 -pg 1 -lvl 3 -x 890 -y 80 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 610 -y 210 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 230 -y 210 -defaultsOSRD
...
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 2 440 60 760
...
if { [get_property IS_LOCKED [ get_files -norecurse system.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/lab3_proj/lab3_proj.gen/sources_1/bd/system/hdl/system_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7z010clg400-1 -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_2
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/lab3_proj.srcs/utils_1/imports/synth_1/system_wrapper.dcp" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7z010clg400-1 -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_2 -parent_run synth_1
} else {
